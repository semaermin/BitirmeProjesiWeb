        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                ...
                <x-slot name="description">
                    {{ __('Ekibinize yeni bir ekip üyesi ekleyerek sizinle işbirliği yapmasına olanak tanıyın.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
                            {{ __('Lütfen bu ekibe eklemek istediğiniz kişinin e-posta adresini girin.') }}
                        </div>
                    </div>
